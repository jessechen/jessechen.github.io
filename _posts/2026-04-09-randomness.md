---
layout: post
title: Why are we so bad at reasoning about randomness?
date: 2026-04-09
categories: inkhaven
image: /assets/monty.svg
---
...
My core argument is that in nature, for every random-seeming event, there are *always* actually patterns behind it that you can identify and exploit. Were you just [attacked by a bear](https://xkcd.com/2381/)? That's a random freak occurrence! But over generations of people getting attacked by bears, they can work out that bears are more likely to live and therefore be encountered in particular environments, tend to be more aggressive when you exhibit certain behaviors and odors, can be warned about in advance by droppings and tree markings, don't show up at all in the winter for some reason, and so on.

In other words, every event that seems totally random is actually part of a pattern that you can learn. In a state of nature, you should always assume that every event has legible, understandable causes. Lightning is more likely to strike tall trees standing alone. More moss tends to grow on a particular side of trees. Cooking food over a fire makes it taste better most of the time, and here's what to do with the exceptions. You're rewarded a with better chance of survival for learning the pattern behind these patterns. The tribe you find yourself in has a correspondingly better chance of flourishing if they trust your expertise. For millennia, survival of the fittest has selected for minds and societies that see patterns in everything.
...
In conclusion, I think there's a huge untapped market opportunity in certifiably [organic random number generators](https://www.polygon.com/2020/11/9/21556590/fish-pokemon-sapphire-stream-twitch/). Just imagine, [an octopus that predicts](https://en.wikipedia.org/wiki/Paul_the_Octopus)—
