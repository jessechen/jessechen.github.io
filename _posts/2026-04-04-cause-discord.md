...
Why does this work so well? I think it has to do with how people tend to deal with the fuzzy boundaries around categories. My current mental model of how most people think about categories is: ask system 1 what feels right, then come up with a justification post facto. This results in inconsistencies and contradictions if you drill down into a specific category with just one person, and results in discord in a group setting.
